...
function callback(msg,callNme) {
	if(callNme=="impAccountCallBack"){
		impAccountCallBack(msg);
	}else if(callNme=="getLocalPathCallBack"){
		getLocalPathCallBack(msg);
	}else if(callNme=="findDetailsByConditionCallBack"){
		findDetailsByConditionCallBack(msg);
	}else if(callNme=="accounteditLoadCallBack"){
		accounteditLoadCallBack(msg);
	}else if(callNme=="analysisDataCallBack"){
		analysisDataCallBack(msg);
	}else if(callNme=="sumgetsSaveCallBack"){
		sumgetsSaveCallBack(msg);
	}else if(callNme=="accountDetailEditCallBack"){
		accountDetailEditCallBack(msg);
	}else if(callNme=="findLockMonthCallBack"){
		findLockMonthCallBack(msg);
